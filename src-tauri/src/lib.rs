...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::llm::list_llm_models_cmd,
            ...
            commands::learning::save_sentence_cmd,
            commands::learning::list_saved_sentences_cmd,
            commands::learning::get_article_quiz_cmd,
            commands::learning::score_expression_cmd,
            commands::learning::get_learning_profile_cmd,
            commands::learning::log_ai_call_cmd,
            commands::learning::clear_ai_call_logs_cmd,
            commands::learning::moderate_content_cmd,
            commands::learning::import_clipboard_article_cmd,
            commands::learning::get_review_summary_cmd,
            commands::learning::list_review_queue_cmd,
            commands::learning::complete_review_item_cmd,
            commands::learning::record_lesson_mistake_cmd,
            commands::learning::should_prompt_assessment_cmd,
            commands::learning::record_assessment_event_cmd,
            commands::learning::save_social_profile_cmd,
            commands::learning::get_social_profile_cmd,
            commands::learning::get_social_recommendations_cmd,
            commands::learning::set_social_block_cmd,
            commands::learning::report_social_user_cmd,
            commands::learning::list_social_reports_cmd,
            commands::learning::submit_sentence_rewrite_cmd,
            commands::learning::adopt_sentence_rewrite_cmd,
            commands::learning::ask_culture_question_cmd,
            commands::learning::save_culture_question_card_cmd,
            commands::learning::get_article_version_cmd,
            // News commands
