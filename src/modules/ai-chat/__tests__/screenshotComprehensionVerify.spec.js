/**
 * Visual snapshot for issue #89 comprehension retake verify wrap-up.
 * Run: SCREENSHOT=1 npm test -- --run src/modules/ai-chat/__tests__/screenshotComprehensionVerify.spec.js
 */
...
import { COMPREHENSION_PRACTICE_PAYLOAD_KEY } from "@/modules/news/comprehensionAiPractice.js";
...
describe.skipIf(!takeScreenshot)("screenshotComprehensionVerify", () => {
  beforeEach(() => {
  ...
  it("writes comprehension retake verify wrap-up primary CTA", async () => {
    ...
    await wrapper.find(".chat-input").setValue("Creo que subieron las tasas para frenar la inflación.");
    ...
    writeScreenshot(wrapper, "issue89-comprehension-verify-wrapup");
